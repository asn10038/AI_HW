...
These 3 papers tackle related challenges under the same umbrella problem. There is almost always a tradeoff between security and usability. The risk is in the fact that when you amp up security at the expense of usability users develop a callousness to security warnings. They tend to just ignore them put them off etc. In the end this makes the system both less secure and less usable. These papers suggest some guidelines/warnings to approach this problem and then evaluate the effectiveness of different approaches.

The authors published a set of guidelines for security warnings that formalize the activity that takes place when a dialogue appears. They also offer a useful table of common problems when users ignore warnings and provide published suggested solutions to those problems.


The first paper published at SOUPS 2013 from CMU in conjunction with Microsoft deals with this problem as it relates to permission alerts from the browser. Different applications ask to install or update various supporting applications to run and as a security precaution the user needs to approve these actions. Unfortunately these alerts appear often and most users don't really check what the alert is asking for before agreeing to it. As such designers can tailor their warnings to the user demographic. They take some space to show examples of poor dialogues and suggest improvements both in the structure and content. The whole document centers around how to make warnings clear, concise, and understandable. Its hard to say more than that without getting into details.


The strategy in the authors' approach was to modify alerts so that they are more visually stimulating than the standard pop ups. Some of the changes they made involved highlighting pieces of the popup, small animations, minor text changes and others. They branded these modifications *attractors*. They also differentiate between inhibitve attractors and non inhibitve attractors. Inhibitve attractors are those which prevent the user from accepting or refusing the pop up immediately. The experiments they conducted involved sending participants in a study to 3rd party sites and testing their acceptance of popups with both control sites, and a manipulated site with the modified popups. They also presented participants with both benign and suspicious scenarios on the study controlled site. In the experiments they tested both installation of downloads from a suspicious publisher and granting suspicious permission privileges to the downloaded software. The results showed that the attractors were rather successful but slowed the users down significantly for those who wanted to disregard the warning. The percentage decrease in suspicious activity approval from the control group varied from 25-85% with most attractors falling somewhere inthe middle of that range. ANSI performed surprisingly well and Type performed the  best across both of the first 2 experiments with. Finally they ran a 3rd experiment testing *habituation*. Habituation is the effect of seeing something repeatedly and becoming less sensitive. It's important to test how effective these measures are when users have seen them many many times. Participants were shown dialogues with the attractor for no real reason during the habituation period, and then they would be shown the dialogue when the attractor highlighted some essential piece of information. Each participant again either installed the software or approved the permissions.  They showed that all 5 inhibitve attractors performed significantly better than the controls while the non inhibitive attractors didn't have the same effect. In the end they determined that inhibitive attractors provide significant improvement over the default, but this improvement comes at a cost of efficiency. It seems like they've said something we already know, security comes at a cost of usability.

 A year later the authors came back and revisited another aspect of the problem. They didn't feel like the previous set of experiments fully analyzed the effect of habituation on the users. The previous experiment tested high levels of habituation not the normal low levels of habituation that come with prolonged exposure over a long period of time. This time they tested the effect of the attractors with high and low level habituation. They used the same attractors as before and designed the experiments in a similar fashion. They measured habituation in two ways, number of times exposed to the pop up and number of seconds exposed to the pop up. In the previous experiments they found that only the attractors that introduced a delay in the process had effective results. In this experiment they found that attractors that introduced delay but didn't require the user to interact with the field worked the best in low habituation environments, but seemed to fail in high habituation situations. They found that attractors that required user activity were the most resistant to habituation. The authors allege that with time people interacted with these attractors very quickly, but I remain dubious of this in real life settings. Again they found that least usabel measures were the most effective, but they maintain that the swipe attractor has low enough overhead that this may be worth considering as an alternative to the current dialogue style.
